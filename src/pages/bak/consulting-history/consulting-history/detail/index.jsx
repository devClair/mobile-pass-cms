...
const ConsultingHistoryDetailComponent = () => {
      ...
      <Grid className="order_detail">
        ...
        <Grid className="table">
          <ul>
            ...
            <li>
              <span className="title">문의차량</span>
            ...
            <li>
              <span className="title">상담일자</span>
              <span className="text">2020.04.04</span>
            </li>
            <li>
              <span className="title">상담딜러</span>
              <span className="text center">뀐</span>
              <span
                className="info"
                onClick={() => {
                  setInfoSw("dealer");
            ...
            <li>
              <span className="title">방문예약</span>
              <span className="text">2020.05.05</span>
            </li>
            <li>
            ...
            <li>
              <span className="title">방문거래</span>
              <span className="text">
                <Radio data={tempRadio} />
              </span>
            </li>
            <li>
              <span className="title">채팅상담내역</span>
        ...
        <Grid container justify="flex-end" className="btn_wrap">
          <ButtonType
            title="목록"
            onClick={() => {
              history.push("/consulting-history");
            }}
          />
          <ButtonType
            title="내역삭제"
...
const ConsultingHistoryDetail = () => {
  return (
    <Layout>
      <ConsultingHistoryDetailComponent />
    </Layout>
  );
};
