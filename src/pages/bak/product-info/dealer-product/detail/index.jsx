...
const DealerProductDetailComponent = () => {
      ...
      <Grid className="customer_detail">
        ...
        <Grid className="table">
          <ul>
            ...
            <li>
              <span className="title">거래소비자</span>
            ...
            <li>
              <span className="title">판매금액(만원)</span>
            ...
            <li>
              <span className="title">차량대금 입금내역</span>
              <span className="text download">다운받기</span>
            </li>
            <li>
              <span className="title">이전비</span>
...
const DealerProductDetail = () => {
  return (
    <Layout>
      <DealerProductDetailComponent />
    </Layout>
  );
};

export default DealerProductDetail;
