...
export const useViewLogic = () => {
  ...
  const createCmsNotice = async (params) => {
    const {
      notice_title,
      notice_content,
      notice_state,
    ...
    try {
      ...
      let responseCreateCmsNotice = await apiObject.createCmsNotice(
        {
          notice_title,
          notice_content,
          notice_state,
      ...
      console.log({ responseCreateCmsNotice });
